 ...
 */
public class jdCargos extends javax.swing.JDialog {
   
   DataConnection miConexion; 
    /**
     * Creates new form jdCargos
     */
    public jdCargos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnGroupCargos = new javax.swing.ButtonGroup();
        ...
        setTitle("Mantenimiento de la tabla cargos");
        setResizable(false);
        ...
        tfNombreCargo.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        tfNombreCargo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfNombreCargoActionPerformed(evt);
            }
        });

        jLabel3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel3.setText("Ingrese el nombre del cargo:");

        jrbtnAgregar.setBackground(new java.awt.Color(255, 255, 255));
        btnGroupCargos.add(jrbtnAgregar);
        jrbtnAgregar.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jrbtnAgregar.setSelected(true);
        jrbtnAgregar.setText("Agregar cargo");
        ...
        btnGroupCargos.add(jrbtnEliminar);
        jrbtnEliminar.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jrbtnEliminar.setText("Eliminar cargo");
        ...
        btnGroupCargos.add(jrbtnModificar);
        jrbtnModificar.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jrbtnModificar.setText("Modificar cargo");
    ...
    private void funcionCrearModeloTabla(){
        try{
            ...
            Tabla.addColumn("Nombre del cargo");
            funcionLlenarTabla();
    ...
    private void funcionLlenarTabla(){
       try{
            ...
            Tabla.addColumn("Codigo");
            Tabla.addColumn("Nombre del cargo");      
                String sSQL = "SELECT CodigoCa, CargoCa FROM cargos";
    ...
    private void funcionAgregar(){
        try{
            if("".equals(tfNombreCargo.getText())){
                JOptionPane.showMessageDialog(this, 
                        "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                    +   "font-size:12px}</style>"
                    +   "<div align=\"center\">Por favor ingrese el nombre del cargo</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                tfNombreCargo.requestFocus();
            }else{
                String Agregar;
                Agregar = "INSERT INTO cargos VALUES("
                        + "null, "
                        + "'"+ tfNombreCargo.getText() +"')";
                Statement stAdd = miConexion.con.createStatement();
                stAdd.executeUpdate(Agregar);
                JOptionPane.showMessageDialog(this, 
                        "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                    +   "font-size:12px}</style>"
                    +   "<div align=\"center\">El cargo fue ingresado exitosamente</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                lblCodigoCargo.setText("");
            ...
            JOptionPane.showMessageDialog(this,"Error: "+ex.getMessage(),"Error al agregar el cargo",JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void funcionModificar(){
        try{
            if("".equals(tfNombreCargo.getText().trim())){
                JOptionPane.showMessageDialog(this, 
                        "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                    +   "font-size:12px}</style>"
                    +   "<div align=\"center\">Por favor seleccione el nombre del cargo desde la tabla</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                tfNombreCargo.requestFocus();
            }else{                
                String Modificar;
                Modificar = "UPDATE cargos SET "
                        + "CargoCa = '"+ tfNombreCargo.getText() +"' "
                        + "WHERE CodigoCa = '"+ lblCodigoCargo.getText() +"'";
                Statement stUpdate = miConexion.con.createStatement();
                stUpdate.executeUpdate(Modificar);
                JOptionPane.showMessageDialog(this, 
                        "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                    +   "font-size:12px}</style>"
                    +   "<div align=\"center\">El cargo fue modificado exitosamente</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                lblCodigoCargo.setText("");
                tfNombreCargo.setText("");
                tfNombreCargo.requestFocus();
            ...
            JOptionPane.showMessageDialog(this,"Error: "+ex.getMessage(),"Error al modificar el cargo",JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void funcionEliminar(){
        try{
            if("".equals(tfNombreCargo.getText().trim())){
                ...
                String Consulta;
                Consulta = "SELECT CargoFu FROM funcionarios "
                        + "WHERE CargoFu = '"+ lblCodigoCargo.getText() +"' LIMIT 1";
                ...
                if(rsSearch.next() == true){
                    JOptionPane.showMessageDialog(this, 
                        "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                    +   "font-size:12px}</style>"
                    +   "<div align=\"center\">No es posible eliminar el cargo, hay funcionarios asignados a él</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                    tfNombreCargo.selectAll();
                    tfNombreCargo.requestFocus();
                }else{
                    String Eliminar;
                    Eliminar = "DELETE FROM cargos "
                            + "WHERE CodigoCa = '"+ lblCodigoCargo.getText() +"'";
                    ...
                    JOptionPane.showMessageDialog(this, 
                            "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                        +   "font-size:12px}</style>"
                        +   "<div align=\"center\">El cargo fue eliminado exitosamente</div></html>", //Mensaje
                            "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                    lblCodigoCargo.setText("");
                    tfNombreCargo.setText("");
                    tfNombreCargo.requestFocus();
            ...
            JOptionPane.showMessageDialog(this,"Error: "+ex.getMessage(),"Error al eliminar el cargo",JOptionPane.ERROR_MESSAGE);
        }
    }    
    ...
    private void jtDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtDatosMouseClicked
        try{
            if(jtDatos.getRowCount() == 0 && jtDatos.getSelectedRow() == -1){
                ...
                String CodigoCa = jtDatos.getValueAt(jtDatos.getSelectedRow(), 0).toString();
                lblCodigoCargo.setText(CodigoCa);
                String NombreCa = jtDatos.getValueAt(jtDatos.getSelectedRow(), 1).toString();
                tfNombreCargo.setText(NombreCa);
            }
        }catch(Exception ex){
    ...
    private void jrbtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jrbtnAgregarActionPerformed
        try{
            ...
            lblCodigoCargo.setText("");
            tfNombreCargo.setText("");
            tfNombreCargo.setEditable(true);
        }catch(Exception ex){
    ...
    private void jrbtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jrbtnEliminarActionPerformed
        try{
            ...
            lblCodigoCargo.setText("");
            tfNombreCargo.setText("");
            tfNombreCargo.setEditable(false);
        }catch(Exception ex){
            JOptionPane.showMessageDialog(this, "Error: "+ex.getMessage());
        }
    }//GEN-LAST:event_jrbtnEliminarActionPerformed

    private void tfNombreCargoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNombreCargoActionPerformed
        funcionGuardar();
    }//GEN-LAST:event_tfNombreCargoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdCargos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdCargos dialog = new jdCargos(new javax.swing.JFrame(), true);
    ...
    private javax.swing.ButtonGroup btnGroupCargos;
