 ...
 */
public class jdEstadoPrestamos extends javax.swing.JDialog {

    DataConnection miConexion;
    
    public jdEstadoPrestamos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Mantenimiento de la tabla estado de préstamos");
        setResizable(false);
        ...
        jLabel3.setText("Ingrese el estado de préstamo:");

        jrbtnAgregar.setBackground(new java.awt.Color(255, 255, 255));
        btnGroupEstado.add(jrbtnAgregar);
        ...
        btnGroupEstado.add(jrbtnEliminar);
        ...
        btnGroupEstado.add(jrbtnModificar);
    ...
    private void funcionLlenarTabla(){
       try{
            ...
            Tabla.addColumn("Codigo");
            Tabla.addColumn("Nombre del estado");      
                String sSQL = "SELECT CodigoEs, EstadoEs FROM estadosprestamos";
    ...
    private void funcionAgregar(){
        try{
            if("".equals(tfNombreEstado.getText())){
                ...
                String Agregar;
                Agregar = "INSERT INTO estadosprestamos VALUES("
                        + "null, "
    ...
    private void funcionModificar(){
        try{
            if("".equals(tfNombreEstado.getText().trim())){
                ...
                String Modificar;
                Modificar = "UPDATE estadosprestamos SET "
                        + "EstadoEs = '"+ tfNombreEstado.getText() +"' "
    ...
    private void funcionEliminar(){
        try{
            if("".equals(tfNombreEstado.getText().trim())){
                ...
                String Eliminar;
                Eliminar = "DELETE FROM estadosprestamos "
                        + "WHERE CodigoEs = '"+ lblCodigoEstado.getText() +"'";
            ...
            JOptionPane.showMessageDialog(this,"Error: "+ex.getMessage(),"Error al estado el estado",JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdEstadoPrestamos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdEstadoPrestamos dialog = new jdEstadoPrestamos(new javax.swing.JFrame(), true);
