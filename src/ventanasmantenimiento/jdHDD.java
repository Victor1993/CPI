 ...
 */
public class jdHDD extends javax.swing.JDialog {

    DataConnection miConexion;
    
    public jdHDD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tfCapacidadDiscoDuro = new javax.swing.JTextField();
        ...
        setTitle("Mantenedor de la tabla discos duros");
        setResizable(false);
        ...
        tfCapacidadDiscoDuro.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        tfCapacidadDiscoDuro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfCapacidadDiscoDuroActionPerformed(evt);
            }
        });
        ...
        jrbtnAgregar.setText("Agregar HDD");
        ...
        jrbtnEliminar.setText("Eliminar HDD");
        ...
        jrbtnModificar.setText("Modificar HDD");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(tfCapacidadDiscoDuro)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addComponent(tfCapacidadDiscoDuro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void funcionCrearModeloTabla(){
        try{
            ...
            Tabla.addColumn("Capacidad de disco duro");
            funcionLlenarTabla();
    ...
    private void funcionLlenarTabla(){
       try{
            ...
            Tabla.addColumn("Codigo");
            Tabla.addColumn("Capacidad de disco duro");      
                String sSQL = "SELECT CodigoDis, DiscoDuroDis FROM capdiscosduros";
    ...
    private void tfCapacidadDiscoDuroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfCapacidadDiscoDuroActionPerformed
        funcionGuardar();
    }//GEN-LAST:event_tfCapacidadDiscoDuroActionPerformed

    private void jrbtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jrbtnAgregarActionPerformed
        try{
            jtDatos.setEnabled(false);
            lblCodigoDiscoDuro.setText("");
            tfCapacidadDiscoDuro.setText("");
            tfCapacidadDiscoDuro.setEditable(true);
        }catch(Exception ex){
    ...
    private void jrbtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jrbtnEliminarActionPerformed
        try{
            ...
            lblCodigoDiscoDuro.setText("");
            tfCapacidadDiscoDuro.setText("");
            tfCapacidadDiscoDuro.setEditable(false);
        }catch(Exception ex){
            JOptionPane.showMessageDialog(this, "Error: "+ex.getMessage());
        }
    ...
    private void jtDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtDatosMouseClicked
        try{
            if(jtDatos.getRowCount() == 0 && jtDatos.getSelectedRow() == -1){
                ...
                String CodigoDis = jtDatos.getValueAt(jtDatos.getSelectedRow(), 0).toString();
                lblCodigoDiscoDuro.setText(CodigoDis);
                String NombreDis = jtDatos.getValueAt(jtDatos.getSelectedRow(), 1).toString();
                tfCapacidadDiscoDuro.setText(NombreDis);
            }
        }catch(Exception ex){
    ...
    private void funcionAgregar(){
        try{
            if("".equals(tfCapacidadDiscoDuro.getText())){
                JOptionPane.showMessageDialog(this, 
                        "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                    +   "font-size:12px}</style>"
                    +   "<div align=\"center\">Por favor ingrese la capacidad de disco duro</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                tfCapacidadDiscoDuro.requestFocus();
            }else{
                String Agregar;
                Agregar = "INSERT INTO capdiscosduros VALUES("
                        + "null, "
                        + "'"+ tfCapacidadDiscoDuro.getText() +"')";
                Statement stAdd = miConexion.con.createStatement();
                stAdd.executeUpdate(Agregar);
                JOptionPane.showMessageDialog(this, 
                        "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                    +   "font-size:12px}</style>"
                    +   "<div align=\"center\">La capacidad de disco duro fue ingresada exitosamente</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                lblCodigoDiscoDuro.setText("");
                tfCapacidadDiscoDuro.setText("");
                tfCapacidadDiscoDuro.requestFocus();
            ...
            JOptionPane.showMessageDialog(this,"Error: "+ex.getMessage(),"Error al agregar la capacidad de disco duro",JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void funcionModificar(){
        try{
            if("".equals(tfCapacidadDiscoDuro.getText().trim())){
                JOptionPane.showMessageDialog(this, 
                        "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                    +   "font-size:12px}</style>"
                    +   "<div align=\"center\">Por favor seleccione la capacidad de disco duro desde la tabla</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                tfCapacidadDiscoDuro.requestFocus();
            }else{                
                String Modificar;
                Modificar = "UPDATE capdiscosduros SET "
                        + "DiscoDuroDis = '"+ tfCapacidadDiscoDuro.getText() +"' "
                        + "WHERE CodigoDis = '"+ lblCodigoDiscoDuro.getText() +"'";
                Statement stUpdate = miConexion.con.createStatement();
                stUpdate.executeUpdate(Modificar);
                JOptionPane.showMessageDialog(this, 
                        "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                    +   "font-size:12px}</style>"
                    +   "<div align=\"center\">La capacidad de disco duro fue modificada exitosamente</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                lblCodigoDiscoDuro.setText("");
                tfCapacidadDiscoDuro.setText("");
                tfCapacidadDiscoDuro.requestFocus();
            ...
            JOptionPane.showMessageDialog(this,"Error: "+ex.getMessage(),"Error al modificar la capaidad de disco duro",JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void funcionEliminar(){
        try{
            if("".equals(tfCapacidadDiscoDuro.getText().trim())){
                ...
                String Consulta;
                Consulta = "SELECT DiscoDuroInf FROM infocomputadores "
                        + "WHERE DiscoDuroInf = '"+ lblCodigoDiscoDuro.getText() +"' LIMIT 1";
                ...
                if(rsSearch.next() == true){
                    ...
                    +   "<div align=\"center\">No es posible eliminar el registro, hay equipos asignados a él</div></html>", //Mensaje
                        "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                    tfCapacidadDiscoDuro.selectAll();
                    tfCapacidadDiscoDuro.requestFocus();
                }else{
                    String Eliminar;
                    Eliminar = "DELETE FROM capdiscosduros "
                            + "WHERE CodigoDis = '"+ lblCodigoDiscoDuro.getText() +"'";
                    ...
                    JOptionPane.showMessageDialog(this, 
                            "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
                        +   "font-size:12px}</style>"
                        +   "<div align=\"center\">La capacidad de disco duro fue eliminada exitosamente</div></html>", //Mensaje
                            "Mensaje de información", JOptionPane.INFORMATION_MESSAGE);
                    lblCodigoDiscoDuro.setText("");
                    tfCapacidadDiscoDuro.setText("");
                    tfCapacidadDiscoDuro.requestFocus();
            ...
            JOptionPane.showMessageDialog(this,"Error: "+ex.getMessage(),"Error al eliminar la capacidad de disco duro"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdHDD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdHDD dialog = new jdHDD(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField tfCapacidadDiscoDuro;
