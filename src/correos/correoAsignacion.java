    ...
    public void funcionEnviarCorreo(String Prestamo){
        try{
            ...
            if(rs.next() == true){
                ...
                String str_Asunto   = NombreFuncionario + " se le ha asignado un insumo";
                // Se compone la parte del texto
                BodyPart str_Mensaje = new MimeBodyPart();
                str_Mensaje.setText("Estimado(a): "+ NombreFuncionario +".\n\n"
                                    + "Se adjunta comprobante de asignación de insumos.\n\n"
                                    + "Saluda atentamente.-\n\n"
                                    + "Víctor Sandoval\n"
                ...
                adjunto.setDataHandler(
                    new DataHandler(new FileDataSource(System.getProperty("user.home") + "\\Desktop\\"+ CodigoPre +"_asignacion.pdf")));
                adjunto.setFileName(CodigoPre +"_asignacion.pdf");
