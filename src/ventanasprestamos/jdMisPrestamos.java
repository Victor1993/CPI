...
public class jdMisPrestamos extends javax.swing.JDialog {

    DataConnection miConexion;
    
    public jdMisPrestamos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void setText(String Usuario){
        tfRutFuncionario.setText(Usuario);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdMisPrestamos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdMisPrestamos dialog = new jdMisPrestamos(new javax.swing.JFrame(), true);
