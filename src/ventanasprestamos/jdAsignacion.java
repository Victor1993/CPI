...
import correos.correoAsignacion;
...
import pdf.pdfAsignacion;
import ventanasinsumos.jdAgregarInsumo;
import ventanasinsumos.jdInsumos;

public class jdAsignacion extends javax.swing.JDialog {

    DataConnection miConexion;
    pdfAsignacion miPrestamo;
    
    public jdAsignacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Asignación de Insumos");
        setResizable(false);
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(tfCodigoInsumo, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnGenerarPdfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarPdfActionPerformed
        String sFichero = System.getProperty("user.home") + "\\Desktop\\"+ tfCodigoPrestamo.getText() +"_asignacion.pdf";
        File Fichero = new File(sFichero);

        if(Fichero.exists() == false){
            pdfAsignacion miPDF = new pdfAsignacion();
            miPDF.GenerarPDF_AsignacionInsumos(tfCodigoPrestamo.getText());
        }else{
            int seleccion = JOptionPane.showOptionDialog(
                null, // Componente padre
                "<html><style>body{font-family:Arial, Helvetica, sans-serif;"
    ...
    private void btnEnviarCorreoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarCorreoActionPerformed
        ...
        if(Fichero.exists() == true){
            correoAsignacion miCorreo = new correoAsignacion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdAsignacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdAsignacion dialog = new jdAsignacion(new javax.swing.JFrame(), true);
